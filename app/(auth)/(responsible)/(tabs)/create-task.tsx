...
import { Container, ButtonEdit, GradientBorderBoxTasks, EditImage, InputDescription, TarefaImage, Voltar, BoxTasks, Input, ContainerButtonsSign, ButtonCreate, Label } from "@/styles/create-task";
