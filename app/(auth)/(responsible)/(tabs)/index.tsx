...
import { ScrollViewContainer, Container, Box, GradientBorderBox, Title, Button, Icons, View, Text } from '@/styles/index-responsible';
      ...
      <GradientBorderBox colors={['#f9d448', '#ffffff', '#f9d448']}>
        <Box>
          <Container>
            <Icons
              resizeMode="contain"
              source={require('../../../../assets/icons/tarefas.png')}
            />
            <View>
